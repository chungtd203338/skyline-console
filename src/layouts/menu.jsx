...
const renderMenu = (t) => {
  ...
  const validatedGettingStartedUrl = isValidUrl(gettingStartedUrl)
    ? gettingStartedUrl
    : null;
  const validatedDocumentationUrl = isValidUrl(documentationUrl)
    ? documentationUrl
    : null;
  const menu = [
    {
    ...
    {
      externalUrl: validatedDocumentationUrl,
    ...
    {
      externalUrl: validatedGettingStartedUrl,
